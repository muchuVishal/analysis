...
#getDbNsfp.withHgmd <- function(fp, fn) {
#  dbNsfpChr <- read.delim(paste(fp, fn, sep="/"))
#  print(paste("read data from ", fp, fn))
...
Using the function above we can collect all dbNSFP variants that have an HGMD annotation across all chromosomes,

```{r collectDbNsfpWithHgmd}
